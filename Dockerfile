...
RUN cd extensions && git clone --depth=1 https://github.com/ProfessionalWiki/SimpleBatchUpload.git SimpleBatchUpload
...
RUN cd extensions && git clone --depth=1 https://github.com/miraheze/RottenLinks.git RottenLinks
