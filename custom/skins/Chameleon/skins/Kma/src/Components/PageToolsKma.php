 ...
 * @ingroup Skins
 */
class PageToolsKma extends Component {
...
*/
		...
		$ret = '<ul class="nav-dropdown">';
		$ret .= implode( $toolGroups );
		$ret .= '</ul>';
		...
		return "<li class=\"$class\"><a class=\"page-tools-kda-edit\" href=\"#!\">$text</a>$subitems</li>";
