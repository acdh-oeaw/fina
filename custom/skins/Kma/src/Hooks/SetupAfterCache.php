...
*/
		...
		// see here https://fontawesome.com/v5/docs/web/setup/host-font-awesome-yourself

		$this->bootstrapManager->addStyleFile(
			$this->configuration['wgStyleDirectory'] . '/Kma/resources-kma/fontawesome-free-5.15.4-web/css/fontawesome.css'
		);

		$this->bootstrapManager->addStyleFile(
			$this->configuration['wgStyleDirectory'] . '/Kma/resources-kma/fontawesome-free-5.15.4-web/scss/regular.scss'
		);

		$this->bootstrapManager->addStyleFile(
			$this->configuration['wgStyleDirectory'] . '/Kma/resources-kma/fontawesome-free-5.15.4-web/scss/solid.scss'
		);

		$this->bootstrapManager->addStyleFile(
			$this->configuration['wgStyleDirectory'] . '/Kma/resources-kma/fontawesome-free-5.15.4-web/scss/brands.scss'
		);
...
// *** not working ?
		$this->bootstrapManager->setScssVariable(
			'fa-font-path',
			$this->configuration['wgStyleDirectory'] . '/Kma/resources-kma/fontawesome-free-5.15.4-web/webfonts'
		);
*/
		...
		// ***edited
		$this->bootstrapManager->addStyleFile(
			$this->configuration['wgStyleDirectory'] . '/Kma/resources-kma/navbar-taniarascia/style.scss'
		);
...
*/
		...
		// load from -> Components/NavbarHorizontalKda.php -> getResourceLoaderModules
		$GLOBALS[ 'wgResourceModules' ][ 'skin.chameleonKma.ace' ] = [
			'localBasePath'  => $this->configuration['wgStyleDirectory'] . '/Kma/resources-kma',
			'remoteBasePath' => $this->configuration['wgStyleDirectory'] . '/Kma/resources-kma',
			'group'          => 'skin.chameleonKma',
			"skinStyles" => [
				'fallback' => [
					// 'jquery-ui/jquery-ui.min.css',
					'Ace-Responsive-Menu/css/ace-responsive-menu.css',
				]
			],
			'skinScripts'    =>
				...
				[ 'fallback' => [
					...
					'navbar-ace.js',
					// 'Ace-Responsive-Menu/js/ace-responsive-menu.js'
					'Ace-Responsive-Menu/js/ace-responsive-menu-min.js'
				]
			],
			// *** missing animations
		...
		////////////////// tania rascia https://gist.github.com/taniarascia/56893ff29f64038dca91

		$GLOBALS[ 'wgResourceModules' ][ 'skin.chameleonKma.taniarascia' ] = [
			'localBasePath'  => $this->configuration['wgStyleDirectory'] . '/Kma/resources-kma',
			'remoteBasePath' => $this->configuration['wgStyleDirectory'] . '/Kma/resources-kma',
			'group'          => 'skin.chameleonKma',
			"skinStyles" => [
		...
		////////////////// nicoletta fabro https://github.com/nicolettafbr/responsive-navbar

		$GLOBALS[ 'wgResourceModules' ][ 'skin.chameleonKma.nicolettafabro' ] = [
			'localBasePath'  => $this->configuration['wgStyleDirectory'] . '/Kma/resources-kma',
			'remoteBasePath' => $this->configuration['wgStyleDirectory'] . '/Kma/resources-kma',
			'group'          => 'skin.chameleonKma',
			"skinStyles" => [
				'fallback' => [
					'navbar-nicolettafabro/style.css'
				]
			],
			'skinScripts'    =>
				[ 'fallback' => [
		...
		////////////////// mdbootstrap https://mdbootstrap.com/docs/b4/jquery/getting-started/installation/

		$GLOBALS[ 'wgResourceModules' ][ 'skin.chameleonKma.mdbootstrap' ] = [
			'localBasePath'  => $this->configuration['wgStyleDirectory'] . '/Kma/resources-kma',
			'remoteBasePath' => $this->configuration['wgStyleDirectory'] . '/Kma/resources-kma',
			'group'          => 'skin.chameleonKma',
			"skinStyles" => [
...
// ***edited
		MediaWikiServices::getInstance()->getSkinFactory()->register( 'kma', 'Chameleon',
			function () {
				$styles = [
					'mediawiki.ui.button',
					'skins.chameleon',
