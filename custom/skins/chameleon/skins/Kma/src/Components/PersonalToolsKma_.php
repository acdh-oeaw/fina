 ...
 * @ingroup Skins
 */
class PersonalToolsKma extends Component {
...
*/
		...
		return ( $this->getSkin()->getUser()->isRegistered() ?
			...
			"<li class=\"$class\"><a class=\"personal-tools-kda-edit\" href=\"#!\"></a></li>"

		: '') .  "<li class=\"$class\"><a class=\"personal-tools-kda-user\" href=\"#!\">$text</a>$subitems</li>";
