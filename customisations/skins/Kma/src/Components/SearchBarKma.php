 ...
 * @ingroup Skins
 */
class SearchBarKma extends Component {
...
/*
return '<li class=""><a class="page-tools-kda-search" href="#!"></a></li>';

      <!-- Define your search form -->
      <form class="navbar-form navbar-left" role="search">
        <!-- Define a button to toggle the search area -->
        <button id="search-button" class="btn btn-default"><li class=""><a class="page-tools-kda-search" href="#!"></a></li></button>
...
return '
<li class=""><a class="no-symbol page-tools-kda-search" href="#!"></a>
