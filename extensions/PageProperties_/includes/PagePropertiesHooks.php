...
class PagePropertiesHooks {
	...
	public static function onParserFirstCallInit( Parser $parser ) {
				...
				$parser->setFunctionHook( 'noparse isHTML', [ self::class, 'ci_noparse_isHTML' ] );
		$parser->setFunctionHook( 'noparse_isHTML', [ self::class, 'ci_noparse_isHTML' ] );



				         $parser->setFunctionHook( 'background image', [ self::class, 'ci_background_image' ] );
                $parser->setFunctionHook( 'background_image', [ self::class, 'ci_background_image' ] );

	}

		public static function ci_noparse_isHTML( Parser $parser, $param1 = '', $param2 = '') {


		return array( str_replace('#1', $param2, $param1), 'noparse' => true, 'isHTML' => true);

	}


             public static function ci_background_image( Parser $parser, $param1 = '') {


                return array( 'background:url(\'' . $param1 . '\')', 'noparse' => true, 'isHTML' => true);
